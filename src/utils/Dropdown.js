...
function Dropdown({
  ...
  return (
    ...
    >
      ...
      >
        {title}
        <svg className="w-3 h-3 fill-current text-black hover:text-purple-600 cursor-pointer ml-1 flex-shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
