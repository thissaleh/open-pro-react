            ...
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              ...
              <div className="flex flex-wrap -mx-3 mb-4">
                  <div className="w-full px-3">
                    <label className="block text-gray-300 text-sm font-medium mb-1" htmlFor="country">Select a Cloud Platform:</label>
                    <select id="country" className="form-select w-full text-gray-300" required>
                    <option></option>
                      <option>AWS</option>
                      <option>Azure</option>
              ...
              <div className="flex flex-wrap -mx-3 mb-4">
                  <div className="w-full px-3">
                    <label className="block text-gray-300 text-sm font-medium mb-1" htmlFor="country">Request Type</label>
                    <select id="country" className="form-select w-full text-gray-300" required>
                      <option placeholder="Enter your email address" required></option>
                      <option>Create RG</option>
                      <option>Create VM</option>
                      <option>Create Database</option>
                      <option>Create Storage</option>
                      <option>Create App Serivce</option>
                      <option>Create VNet</option>
              ...
              <div className="flex flex-wrap -mx-3 mb-4">
                  <div className="w-full px-3">
                    <label className="block text-gray-300 text-sm font-medium mb-1" htmlFor="country">Region</label>
                    <select id="country" className="form-select w-full text-gray-300" placeholder="Enter your email address" required>
                    <option></option>
