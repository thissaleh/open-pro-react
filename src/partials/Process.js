      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-10 pb-12 md:pt-16 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4" data-aos="fade-up">Cloud self-service built for you!</h2>
            <p className="text-xl text-gray-400" data-aos="fade-up" data-aos-delay="200">We automate the whole process and deployment of BAT Azure/AWS change requests, from raising the request to deploying it in the cloud.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-3 lg:gap-16 items-start md:max-w-none">
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up">
              ...
              <h4 className="h4 mb-2"><span className="text-gray-400">1</span>. Request</h4>
              <p className="text-lg text-gray-400 text-center">Request cloud infrastructure through our self service web portal.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200">
              ...
              <h4 className="h4 mb-2"><span className="text-gray-400">2</span>. Cloud Automation</h4>
              <p className="text-lg text-gray-400 text-center">Next, the whole process is automated for you.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400">
              ...
              <h4 className="h4 mb-2"><span className="text-gray-400">3</span>. Get Cloud Resources</h4>
              <p className="text-lg text-gray-400 text-center">Start using your cloud infrastructure.</p>
            </div>
